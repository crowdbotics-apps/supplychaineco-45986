"""
Django settings for supplychaineco_45986 project.
...
ROOT_URLCONF = 'supplychaineco_45986.urls'
...
WSGI_APPLICATION = 'supplychaineco_45986.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "supplychaineco_45986 API",
    "DESCRIPTION": "API documentation for supplychaineco_45986 App",
    "VERSION": "v1",
}
